...
| 6 — full match for every slot | host half **done**: `targets()`, per-slot scoring, `test/net-match.test.ts` (D-180). Presentation of remote state not started; one defect open (GAP-045) |
